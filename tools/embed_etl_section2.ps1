...
$etlBlock = @(
'print("\n--- סעיף 2 (Refactor): טעינת נתוני JSON מוטמעים + ETL ---")',
'',
'// NOTE: הקבצים הוטמעו ישירות כ-Array literals כדי שהסקריפט יהיה Standalone.',
...
'        inserted += batch.length;',
'    }',
'    print("נטענו " + inserted + " מסמכים עבור " + label);',
'}',
'',
'print("\n--- ETL Load: CPUs ---")',
...
$pattern = '(?s)// ============================================================\r?\n// סעיף 2: הכנסת נתונים - Polymorphic Pattern עם requirements\r?\n// ============================================================\r?\n.*?(?=// ============================================================\r?\n// הכנסת נתונים - אוסף builds)'
